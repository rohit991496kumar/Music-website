...
const DashBoardNewSong = () => {
    ...
    const [{ allArtists,
        ...
        filterTerm,
        languageFilter,
        alertType }, dispatch] = useStateValue();
        ...
        <div className='flex  flex-col items-center justify-center p-4 border border-gray-300 gap-4 rounded'>
           ...
           outline-none shadow-sm border border-gray-300 bg-transparent'
            ...
            <div className='flex w-full justify-between flex-wrap items-center gap-4'>
                <FilterButtons filterData={allArtists} flag={"Ministery"} />
            ...
            <div className="flex items-center justify-center w-60 p-4 cursor-pointer">
                {isImageLoading || isAudioLoading ? (
                    ...
                    className=" px-8 py-2 rounded-md text-white bg-red-600
hover:shadow-lg"
                    onClick={saveSong}
                >
                    Save Song
            ...
            <p className="text-xl font-semibold text-headingColor"> Ministery Details</p>
           ...
           outline-none shadow-sm border border-gray-300 bg-transparent'
            ...
            <div className="flex items-center rounded-md p-3 border border-gray-300 w-full">
                <p className="text-base font-semibold text-gray-400"> www.youtube.com/</p>
                <input type="text" placeholder="your youtube channel"
...
export const FileLoader = ({ progress }) => {
    return (
        <div className='w-full h-full flex flex-col items-center justify-center'>
            ...
            <div className='w-20 h-20 min-w-[40px] bg-red-600 animate-ping 
    ...
    return <label>
        <div className='flex flex-col items-center justify-center h-full' >
            <div className='flex flex-col items-center justify-center cursor-pointer '>
                ...
                <p className='text-lg'> click to upload {isImage ? "an image " : " an audio "}
