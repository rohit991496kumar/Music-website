...
const MusicPlayers = () => {
    ...
    return (
        <div className='w-full  flex items-center gap-3 '>
            <div className={`w-full items-center gap-3 py-4 flex relative`}>
...
export const PlayListCard = () => {
    ...
    return (
        <div
            className="absolute left-4 bottom-24 gap-2 w-350 max[350px] h-510 max-h-[510px] flex flex-col overflow-y-scroll scrollbar-thin
        rounded-md shadow-md bg-primary"
        >{
                allSongs.length > 0 ? (
                    allSongs.map((music, index) => (
                        <motion.div
                            ...
                            key={index}
                        >
                            <IoMusicalNote className="text-textColor w-32 group-hover:text-headingColor text-2xl cursor-pointer" />
                            <div className="flex  items-start flex-col">
